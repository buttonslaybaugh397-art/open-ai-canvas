...
func newResourceTestService(t *testing.T) *Service {
	...
	if err := db.AutoMigrate(&model.SystemSetting{}, &model.UserOSSSetting{}, &model.UserDailyUploadUsage{}, &model.Resource{}, &model.SessionFile{}, &model.TeamAssetResource{}); err != nil {
		t.Fatal(err)
	}
