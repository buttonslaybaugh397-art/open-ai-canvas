...
func TestUserAssetsBatchIsBoundedAndScoped(t *testing.T) {
	...
	if err := json.Unmarshal(assets[0], &asset); err != nil {
		t.Fatalf("decode asset: %v", err)
	}
	if asset["id"] != "owner" || asset["coverUrl"] == nil || asset["tags"] == nil || asset["createdAt"] == nil || asset["updatedAt"] == nil {
		t.Fatalf("asset client payload was not completed: %#v", asset)
	}
