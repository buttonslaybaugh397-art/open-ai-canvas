...
export function defaultBaseUrlForChannelInterface(interfaceType?: ChannelInterfaceType) {
    ...
    if (interfaceType === "grok-image" || interfaceType === "newapi" || interfaceType === "newapi-channel-1" || interfaceType === "newapi-channel-2" || interfaceType === "seedance-videos" || interfaceType === "xai-video") return "";
