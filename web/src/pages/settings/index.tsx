...
import { ArrowLeft, Boxes, Bug, CircleUserRound, Cloud, MessageSquareText, RadioTower, SlidersHorizontal, Workflow } from "lucide-react";
...
import { AccountSettingsPane } from "./account-settings-pane";
import { RUNNINGHUB_PLUGIN_ID } from "@/lib/plugins/builtin/workflows";
import { usePluginStore } from "@/stores/use-plugin-store";

type ConfigSectionKey = "account" | "channels" | "models" | "runninghub" | "preferences" | "prompts" | "storage" | "diagnostics";

const configSections: Array<{ key: ConfigSectionKey; label: string; description: string; icon: ReactNode }> = [
    { key: "account", label: "账号设置", description: "", icon: <CircleUserRound className="size-4" /> },
...
export default function SettingsPage() {
    ...
    const panes: Record<ConfigSectionKey, ReactNode> = {
        account: <SettingsPane><AccountSettingsPane /></SettingsPane>,
