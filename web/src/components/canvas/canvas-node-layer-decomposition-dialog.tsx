...
export function CanvasNodeLayerDecompositionDialog({ dataUrl, open, config, onClose, onConfirm }: { dataUrl: string; open: boolean; config: AiConfig; onClose: () => void; onConfirm: (payload: CanvasImageLayerDecompositionPayload) => void }) {
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="mt-auto flex justify-end gap-2">
                        ...
                        <Button
                            ...
                            onClick={() => onConfirm({ prompt: selectedPrompt, regions, generationConfig: { model: generationConfig.model, imageModel: generationConfig.imageModel, size: generationConfig.size, quality: generationConfig.quality } })}
                        >
                            开始拆分
                        </Button>
                    </div>
