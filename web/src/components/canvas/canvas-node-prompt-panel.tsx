...
export function CanvasNodePromptPanel({ projectId, node, isRunning, onPromptChange, onConfigChange, onGenerate, mentionReferences = [], onAddReference, onRemoveReference, onReorderReferences, onReplaceReference, onReplaceReferenceFiles, onClose, onNodeMouseDown, onImageSettingsOpenChange, workspaceMode = "professional" }: CanvasNodePromptPanelProps) {
    ...
    const composerHeight = clampPromptHeight(manualPromptHeight ?? promptContentHeight + referenceShelfHeight, promptBounds);
    const expandedComposerHeight = clampPromptHeight(manualExpandedPromptHeight ?? expandedPromptContentHeight + referenceShelfHeight, expandedPromptBounds);
    ...
    useEffect(() => {
        ...
        setManualExpandedPromptHeight((height) => reconcilePromptHeight(height, previousShelfHeight, referenceShelfHeight, expandedPromptBounds));
        previousReferenceShelfHeightRef.current = referenceShelfHeight;
    }, [expandedPromptBounds.max, expandedPromptBounds.min, promptBounds.max, promptBounds.min, referenceShelfHeight]);
...
function promptEditorBounds(expanded: boolean, hasReferences: boolean): PromptEditorBounds {
