...
import { applyGeneratedMediaResultMetadata, applyGenerationTaskResultToNodes, generationTaskNodeId, mergeGenerationTaskResultNodes, videoMetadata } from "@/lib/canvas/canvas-generation-task-sync";
